...
\begin{table}[h]
\centering
% Defines a 3x3 grid with columns 3cm wide, centered, with vertical lines
\begin{tabular}{|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
\hline
Row 1, Col 1 & Row 1, Col 2 & Row 1, Col 3 & Row 1, Col 4  & Row 1, Col 5  \\ \hline

% FIRST ROW
$ \square $
\begin{itemize}
    \setlength{\itemsep}{0pt}  % Removes the extra space between items
    \setlength{\parsep}{0pt}   % Removes extra space if an item has multiple paragraphs
...
% \begin{tikzpicture}[node distance=1.0cm , trim left=-1cm, scale=2]

%     \draw[help lines, opacity=1, inner sep=2pt] (0,0) grid (5, 4 );

%     \node (p)  at ( 3.5, 0) [draw, font=\fontsize{7}{9}\selectfont\sffamily\bfseries] {N};
